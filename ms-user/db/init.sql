...
CREATE TABLE `t_user` (
  ...
  `fuser_name` varchar(255) NOT NULL DEFAULT '' COMMENT '用户姓名',
  `fsex` tinyint(1) NOT NULL DEFAULT '1' COMMENT '性别 (0-女|1-男)',
  `fid_no` varchar(255) NOT NULL DEFAULT '' COMMENT '身份证号',
  `fage` tinyint(2) NOT NULL DEFAULT '0' COMMENT '年龄',
  `faddress` varchar(255) NOT NULL DEFAULT '' COMMENT '家庭住址',
  `fphone` varchar(255) NOT NULL DEFAULT '' COMMENT '联系电话',
